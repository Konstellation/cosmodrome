...
HTTPS_GIT := https://github.com/konstellation/cosmodrome.git
...
ldflags = -X github.com/cosmos/cosmos-sdk/version.Name=cosmodrome \
...
ifeq ($(OS),Windows_NT)
	...
	go build -mod=readonly $(BUILD_FLAGS) -o build/cosmodrome ./cmd/cosmodrome
endif
...
install: go.sum
	go install -mod=readonly $(BUILD_FLAGS) ./cmd/cosmodrome
